...
namespace WebShop.Data.Migrations
{
    ...
    [Migration("20211221110556_FileSystemCarUpdate")]
    partial class FileSystemCarUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebShop.Core.Domain.ExistingFilePathForCar", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ExistingFilePathForCar");
                });
            ...
            modelBuilder.Entity("WebShop.Core.Domain.ExistingFilePathForCar", b =>
                {
                    b.HasOne("WebShop.Core.Domain.Car", null)
                        .WithMany("ExistingFilePathsForCar")
                        .HasForeignKey("CarId");
                });

            modelBuilder.Entity("WebShop.Core.Domain.Car", b =>
                {
                    b.Navigation("ExistingFilePathsForCar");
                });
